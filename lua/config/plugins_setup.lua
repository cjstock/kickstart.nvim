...
-- Dank Material Shell dynamic theming.
-- DMS regenerates colors/dms.lua on every theme apply; that file reads
-- ~/.config/DankMaterialShell/settings.json, builds the palette via base46,
-- and installs an fs_event watcher that hot-reloads on the next apply.
