-- Pre-declare every omarchy theme plugin so lazy.nvim installs them all,
-- but keeps them unloaded until the hotreload handler asks for one.
-- Mirrors /usr/share/omarchy-nvim/config/lua/plugins/all-themes.lua.
return {
